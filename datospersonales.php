                        ...
                        <ul class="navbar-nav flex-column w-100 h-100 d-flex">
                            ...
                            <li class="d-grid gap-3 mt-auto">
                                ...
                                <a href="./iniciosesion.html"
                                    ...
                                    <picture>
                                        <img src="./img/mujer.png" alt="foto perfil" class="img-fluid rounded-circle position-absolute top-0 start-0 d-none d-md-block m-1" style="width: 60px;"> 
                                    </picture>
                            ...
                            ?>
                                <div class="form-row row justify-content-md-center">
                                    <div class="form-group col-md-4">
                                        ...
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['nombre']?></p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="apellido_paterno">Apellido Paterno</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['apellidoPaterno']?>
                                        </p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="apellido_materno">Apellido Materno</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['apellidoMaterno']?>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-row row justify-content-md-center">
                                    <div class="form-group col-md-12">
                                        ...
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['email']?></p>
                                    </div>
                                </div>
                                <div class="form-row row justify-content-md-center">
                                    <div class="form-group col-md-4">
                                        <label for="fecha_nacimiento">Fecha Nacimiento</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['fecNacimiento']?>
                                        </p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="dni">Dni</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['dni']?></p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="celular">Celular</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['celular']?></p>
                                    </div>
                                </div>
                                <div class="form-row row justify-content-md-center">
                                    <div class="form-group col-md-4">
                                        <label for="ciudad">Ciudad</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['ciudad']?></p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="provincia">Provincia</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['provincia']?></p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="departamento">Distrito</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['distrito']?></p>
                                    </div>
                                </div>
                                <div class="form-row row justify-content-md-center">
                                    <div class="form-group col-md-6">
                                        <label for="sexo">Sexo</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['sexo']?></p>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="sexo">Estado Civil</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['estadoCivil']?></p>
                                    </div>
                                </div>
                                <div class="form-row row justify-content-md-center">
                                    <div class="form-group col-md-4">
                                        <label for="direccion">Dirección</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['direccion']?></p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="ruc">Ruc</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['ruc']?></p>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="tipo_sangre">Tipo Sangre</label>
                                        <p class="text-dark bg-white p-2 rounded"><?php echo $datos['tipoSangre']?></p>
                                    </div>
                                </div>
                                <div class="form-row row justify-content-md-center">
